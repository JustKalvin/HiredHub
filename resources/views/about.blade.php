    ...
    <main class="flex-grow-1">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center g-4">
                    <div class="col-6 col-md-4 col-lg-3 text-center">
                        <div class="rounded-circle bg-secondary mx-auto mb-3 overflow-hidden shadow-sm" style="width: 120px; height: 120px;">
                            <img src="{{ asset('images/profile.png') }}" alt="Dara" class="w-100 h-100 object-fit-cover">
                        </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 text-center">
                        <div class="rounded-circle bg-secondary  mx-auto mb-3 overflow-hidden shadow-sm border" style="width: 120px; height: 120px;">
        ...
        <section class="container py-5 text-center">
            <div class="p-5 rounded-3 text-white" style="background: linear-gradient(to right, #172B4D, #0d6efd);">
                ...
                <a class="btn btn-light btn-lg px-4 fw-bold text-primary" data-bs-toggle="collapse" href="#browseForm" role="button">
                    Browse Jobs Now
                </a>
            </div>
        </section>
